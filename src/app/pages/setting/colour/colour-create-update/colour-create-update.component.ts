...
@Component({
  selector: 'app-colour-create-update',
  templateUrl: './colour-create-update.component.html',
  styleUrls: ['./colour-create-update.component.scss']
})
export class ColourCreateUpdateComponent implements OnInit {
        ...
        if (this.id === 0) {
          this.apiService.postRequest(this.baseRoute, { _route: "create" }, postParams)
            ...
            .subscribe((response: any) => {
              if (response.status === 1) {
                this.toastrService.success('Colour created successfully!');
                this.router.navigate(['/pages/colour/']);
              } else {
          ...
          this.apiService.postRequest(this.baseRoute, { id: this.id, _route: "update" }, postParams)
            ...
            .subscribe((response: any) => {
              ...
              if (response.status === 1) {
                this.toastrService.success('Colour updated successfully!');
                this.router.navigate(['/pages/colour/']);
              } else {
                console.log(response);
              }
